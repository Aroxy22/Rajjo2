        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {allImages.map((src, index) => {
            return (
              ...
              >
                <div 
                  className="relative rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 bg-white border-2 border-pink-200/50 hover:border-pink-300"
                  style={{
                    width: IMAGE_SIZE,
                    height: IMAGE_SIZE,
                    margin: "0 auto",
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/0 via-transparent to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300" />
                </div>
              </motion.div>
            );
          })}
