...
const memoryPlaceholders = [
  {
    ...
    note: "Here you can add a photo from around 18th April — the day I kissed you on the cheek for the first time. Even if there isn’t an exact photo, any picture from that time will always remind me how shy, sweet and electric that moment felt.",
  },
  {
    src: "/photo2.jpg",
