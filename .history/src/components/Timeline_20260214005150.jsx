...
const events = [
  ...
  },
  {
    ...
    desc: "The infamous trip to Pondicherry. The first time we properly got away together, explored new streets, tried new food, and definitely took way too many photos. But every single one of them is still my favorite because it is us, together, in a place that started to feel like ours.\n\nWhat made it even more special was the fact that you took a risk to come. You stepped out of your comfort zone, trusted me, and chose to be there with me. That meant more than I probably said out loud. Thank you for believing in us enough to do that.\n\nThe trip was not just about the beaches or the cafes or the long walks. It was about the conversations, the quiet moments, the small laughs, and the way everything felt lighter when we were side by side.\n\nLooking back, it was not just a getaway. It was a memory that proved we could create something of our own, anywhere, as long as we were together. And honestly, the journey itself was just as beautiful as the destination.",
    image: "/pondy_trip.jpeg",
  },
  {
    label: "Everything after • The best part ✨",
    title: "All the little moments that followed",
    desc: "After the first kiss, the proposal, the first 'I love you', and that trip, it was the small things that really stayed. The random calls. The stupid inside jokes. The late night talks that somehow never felt long enough. And all the times we chose each other on completely ordinary days.\n\nSomewhere along the way, we just got used to each other in the best way possible. Meeting again and again. Coming back to college and finding time between classes. Sitting together without needing something big to happen. It stopped being about special occasions and started being about everyday presence.\n\nWe have met so many times since then, created so many small memories that would probably seem insignificant to anyone else, but they mean everything to me.\n\nThat is my favorite part of our story. Not just the big milestones, but the fact that we kept showing up for each other. And we still do.",
    image: null,
  },
];
