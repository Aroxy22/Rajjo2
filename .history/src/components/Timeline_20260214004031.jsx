...
const events = [
      ...
      ,
 {
  label: "18th April • That soft first kiss 💋",
  title: "Cheek kiss number one",
  desc: "18th April. We went for a movie that day, and even though I do not remember much about the film, I remember exactly how I felt. You were leaving for Pondicherry soon, and I kept thinking about how strange it would feel not seeing you for a while. That was probably the first time I realized I was genuinely invested. It was no longer just hanging out. It actually mattered to me.\n\nAfter the movie, when we stepped outside, I hugged you a little tighter than usual. I did not say much about why. I just did not want the moment to end. And then you kissed me on the cheek.\n\nIt was simple and quick, but it meant more than you probably knew. I did not react dramatically. I did not freeze or say anything clever. I just felt this quiet happiness settle in. It was the first time something shifted for me in a very real way.\n\nLater that night, I caught myself replaying it in my head, smiling for no reason. That small moment made everything feel possible. It was subtle, but it stayed with me."
  image: "/cheek_kiss.jpeg",
}
,
  {
